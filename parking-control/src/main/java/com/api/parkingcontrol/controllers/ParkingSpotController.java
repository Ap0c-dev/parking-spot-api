...
public class ParkingSpotController {
    ...
    public  ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto){
        ...
        BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel);//Convert parkingSpotD to parkingSpotModel, so it can be saved to DB.
        parkingSpotModel.setRegistrationDate(LocalDateTime.now(ZoneId.of("UTC")));//Setting the date.
